...
extra_versions="
0.8.1 0.15.1 0.16.1 0.18.1 0.20.1 0.20.2 0.20.3
0.28.1 0.28.2 0.28.3 0.30.1 0.30.2 0.36.1
0.38.1 0.38.2 0.39.1 0.39.2 0.39.3 0.39.4 0.40.1 0.48.1 0.48.2
0.51.1 0.52.1 0.53.1 0.53.2 0.53.3 0.54.1 0.56.1
...
if [ "$pentest_count" -ne 221 ]; then
    echo "implementation plan: expected 221 exact-commit pentest stops, found $pentest_count" >&2
    failed=1
fi
