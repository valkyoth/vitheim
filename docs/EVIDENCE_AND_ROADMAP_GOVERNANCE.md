...
The roadmap contains exactly **396 independently pentestable release stops**:
...
included. “151 base stops” and “396 exact release stops” describe different
...
and requires 396 exact-commit pentest markers. Reopened `0.1.0` must replace
...
`0.51.21–0.51.30` evaluate reinstall, serialize activation against abort,
...
permanent-unknown quarantine recovery, create one proof-bound fresh successor
after quarantine, consume the fully admitted successor, supersede the guard,
and reconcile both release families;
