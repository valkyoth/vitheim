...
The roadmap contains exactly **229 independently pentestable release stops**:

`150 base 0.x.0 stops + 78 companion/patch stops + 1 production stop = 229`.

The public `.0` skeleton still contains 151 base stops when `1.0.0` is
included. “151 base stops” and “229 exact release stops” describe different
views and must always be qualified. The phrases “151 phases,” “225
milestones,” and “228 exact stops” are not valid repository descriptions.
...
and requires 229 exact-commit pentest markers. Reopened `0.1.0` must replace
...
combinations. `0.140.1–0.140.11` revalidate and freeze already evidenced
