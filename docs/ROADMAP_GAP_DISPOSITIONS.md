...
| Production options were implicit | Add `0.140.1–0.140.9` production-profile freeze decisions covering dependency/crypto, storage/tenancy, identity, plugins, privacy, deployment, SDK publication, AI, and interchange before Phase O. |
