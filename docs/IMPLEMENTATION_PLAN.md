...
The canonical roadmap contains 395 exact release stops: 150 base `0.x.0`
stops, 244 companion stops, and one `1.0.0` stop. Only the limited `0.1.0`
...
families that exceeded it, and records 101 later focused capability,
...
`0.51.21–0.51.29` evaluate reinstall, linearize activation against abort,
...
permanent-unknown quarantine recovery, consume the completely admitted
