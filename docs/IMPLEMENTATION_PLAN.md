...
The canonical roadmap contains 392 exact release stops: 150 base `0.x.0`
stops, 241 companion stops, and one `1.0.0` stop. Only the limited `0.1.0`
...
families that exceeded it, and records 98 later focused capability,
...
`0.51.21–0.51.26` evaluate reinstall, obtain source-partition activation
admission, fund durable bridge ownership, terminate or supersede partial
admission, consume the completely admitted successor, and release both
