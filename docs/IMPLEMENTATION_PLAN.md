...
The canonical roadmap contains 377 exact release stops: 150 base `0.x.0`
stops, 226 companion stops, and one `1.0.0` stop. Only the limited `0.1.0`
...
families that exceeded it, and records 83 later focused capability,
...
successor head to one canonical protection root, `0.51.10` reconciles exact
children/never-present coverage, and `0.51.11` transfers permanent protection
before final clean completion. `0.145.4`
