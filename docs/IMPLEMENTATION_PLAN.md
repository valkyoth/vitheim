...
The canonical roadmap contains 396 exact release stops: 150 base `0.x.0`
stops, 245 companion stops, and one `1.0.0` stop. Only the limited `0.1.0`
...
families that exceeded it, and records 102 later focused capability,
...
`0.51.21–0.51.30` evaluate reinstall, linearize activation against abort,
...
permanent-unknown quarantine recovery, create exactly one fresh proof-bound
replacement successor, consume the completely admitted successor, and release
both candidate-control families.
`0.145.4`
