...
reviews added 31 requirement-source, dependency-feasibility, phased surface-
ownership, domain-boundary, adapter-placement, and chronological-integration
stops. The canonical roadmap therefore contains **377 exact stops**:
...
The 31 coherence additions live in
...
| Domain retirement | `0.30.28–0.30.29`, `0.51.5–0.51.11`, `0.145.4` | Truthful terminals/exact children; cut/admission/succession; narrow guard and post-cut evidence; joint protection root; reconciled mixed coverage; permanent-guard takeover and final completion; destructive certification |
...
again before implementation. The roadmap checker verifies all 377 headings,
