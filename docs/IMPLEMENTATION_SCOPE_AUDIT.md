...
reviews added 34 requirement-source, dependency-feasibility, phased surface-
ownership, domain-boundary, adapter-placement, and chronological-integration
stops. The canonical roadmap therefore contains **380 exact stops**:

`150 base 0.x.0 stops + 229 companion stops + 1 production stop = 380`.
...
The 34 coherence additions live in
...
| Domain retirement | `0.30.28–0.30.29`, `0.51.5–0.51.14`, `0.145.4` | Truthful terminals/exact children; cut/plan/succession/guard/root; terminal aggregation and residual owners; exact takeover authority; classified completion; final-state-only reinstall; destructive certification |
...
again before implementation. The roadmap checker verifies all 380 headings,
