...
reviews added 29 requirement-source, dependency-feasibility, phased surface-
ownership, domain-boundary, adapter-placement, and chronological-integration
stops. The canonical roadmap therefore contains **375 exact stops**:
...
The 29 coherence additions live in
...
| Domain retirement | `0.30.28–0.30.29`, `0.51.5–0.51.9`, `0.145.4` | Orthogonal clean/loss terminals and exact-tenant recovery; deployment cut/release; approved exact-cut admission; successor authority; narrow guard plus post-cut absence/handoff; bounded pausable isolated-child campaign; destructive certification |
...
again before implementation. The roadmap checker verifies all 375 headings,
