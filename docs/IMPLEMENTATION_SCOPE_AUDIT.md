...
reviews added 26 requirement-source, dependency-feasibility, phased surface-
ownership, domain-boundary, adapter-placement, and chronological-integration
stops. The canonical roadmap therefore contains **372 exact stops**:
...
The 26 coherence additions live in
...
| Domain retirement | `0.30.28–0.30.29`, `0.51.5–0.51.6`, `0.145.4` | Orthogonal clean/loss terminal contract, exact tenant authority/recovery, authoritative deployment membership cut, bounded isolated-child campaign, then destructive certification |
...
again before implementation. The roadmap checker verifies all 372 headings,
