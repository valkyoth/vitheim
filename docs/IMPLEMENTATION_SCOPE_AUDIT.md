...
reviews added 27 requirement-source, dependency-feasibility, phased surface-
ownership, domain-boundary, adapter-placement, and chronological-integration
stops. The canonical roadmap therefore contains **373 exact stops**:
...
The 27 coherence additions live in
...
| Domain retirement | `0.30.28–0.30.29`, `0.51.5–0.51.7`, `0.145.4` | Orthogonal clean/loss terminal contract, exact tenant authority/recovery, authoritative deployment membership cut and release lifecycle, separately approved exact-cut plan/admission, bounded pausable isolated-child campaign, then destructive certification |
...
again before implementation. The roadmap checker verifies all 373 headings,
