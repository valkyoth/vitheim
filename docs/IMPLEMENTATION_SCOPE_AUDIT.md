...
reviews added 49 requirement-source, dependency-feasibility, phased surface-
ownership, domain-boundary, adapter-placement, and chronological-integration
stops. The canonical roadmap therefore contains **395 exact stops**:

`150 base 0.x.0 stops + 244 companion stops + 1 production stop = 395`.
...
The 49 coherence additions live in
...
| Domain retirement | `0.30.28–0.30.29`, `0.51.5–0.51.29`, `0.145.4` | Truthful terminals; cut/plan/guard/root; residual handoff/lineage/cuts; restrictive invalidation; takeover/release; funded retained controls; archival/retained namespace; fenced evaluation; linearized activation/abort; source-partition admission; canonical empty ownership/disposition; funded bridge ownership; partial-admission abort/supersession; permanent-unknown decision/quarantine; guard consumption/dual release; certification |
...
again before implementation. The roadmap checker verifies all 395 headings,
