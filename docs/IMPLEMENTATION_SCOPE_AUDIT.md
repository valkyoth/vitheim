...
stops. The canonical roadmap therefore contains **398 exact stops**:
...
The 52 coherence additions live in
...
| Domain retirement | `0.30.28–0.30.29`, `0.51.5–0.51.32`, `0.145.4` | Truthful terminals; cut/plan/guard/root; residual handoff/lineage/cuts; restrictive invalidation; takeover/release; funded retained controls; archival/retained namespace; fenced evaluation; explicit lifecycle adjacency; source-partition admission; root-bound activation preparation; canonical empty ownership/disposition; funded bridge ownership; partial-admission abort/supersession; permanent-unknown decision/quarantine; enforced unknown-restriction top; bounded replacement-evaluation lineage; proof-bound successor genesis; tagged guard consumption/dual release; certification |
...
again before implementation. The roadmap checker verifies all 398 headings,
