...
reviews added 24 requirement-source, dependency-feasibility, phased surface-
ownership, domain-boundary, adapter-placement, and chronological-integration
stops. The canonical roadmap therefore contains **370 exact stops**:
...
The 24 coherence additions live in
...
| Domain retirement | `0.30.28–0.30.29`, `0.145.4` | Introduction-time lifecycle/fence/drain/disposition contract, separate authority/crash recovery, then destructive history/restore/reinstall certification |
...
again before implementation. The roadmap checker verifies all 370 headings,
