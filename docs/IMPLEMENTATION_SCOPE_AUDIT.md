...
reviews added 18 requirement-source, dependency-feasibility, phased surface-
ownership, domain-boundary, adapter-placement, and chronological-integration
stops. The canonical roadmap therefore contains **364 exact stops**:
...
| Cross-surface integration | `0.60.3–0.60.4`, `0.70.4–0.70.5`, `0.100.1–0.100.2`, `0.120.8–0.120.10`, `0.132.3–0.132.4`, `0.138.4–0.138.7`, `0.139.1`, `0.145.3` | Per-vocabulary extension/backfill, then separate certification; late lifecycle/recovery remains certification-only |
...
The 18 coherence additions live in
...
| Domain identity | `0.30.23` | Stable manifest and opaque typed references only |
| Contribution safety | `0.30.24–0.30.25` | Reference/generation composition, then bounded deferral/product gates |
| Supplier boundary | `0.50.18` | Performance assessment and inert risk proposals only |
| Tenant-surface linkage | `0.51.3` | Reference authoritative lifecycle IDs; never duplicate their fields |
...
again before implementation. The roadmap checker verifies all 364 headings,
