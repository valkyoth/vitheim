...
reviews added 38 requirement-source, dependency-feasibility, phased surface-
ownership, domain-boundary, adapter-placement, and chronological-integration
stops. The canonical roadmap therefore contains **384 exact stops**:
...
The 38 coherence additions live in
...
| Domain retirement | `0.30.28–0.30.29`, `0.51.5–0.51.18`, `0.145.4` | Truthful terminals; cut/plan/guard/root; tenant-local handoff/lineage/delivery cuts; slot takeover; reserved completion; archival cleanup; fenced reinstall evaluation/consumption; certification |
...
again before implementation. The roadmap checker verifies all 384 headings,
