...
reviews added 46 requirement-source, dependency-feasibility, phased surface-
ownership, domain-boundary, adapter-placement, and chronological-integration
stops. The canonical roadmap therefore contains **392 exact stops**:

`150 base 0.x.0 stops + 241 companion stops + 1 production stop = 392`.
...
The 46 coherence additions live in
...
| Domain retirement | `0.30.28–0.30.29`, `0.51.5–0.51.26`, `0.145.4` | Truthful terminals; cut/plan/guard/root; residual handoff/lineage/cuts; restrictive invalidation; takeover/release; funded retained controls; archival/retained namespace; fenced evaluation; source-partition activation admission; funded bridge ownership; partial-admission abort/supersession; guard consumption/dual release; certification |
...
again before implementation. The roadmap checker verifies all 392 headings,
