...
reviews added 35 requirement-source, dependency-feasibility, phased surface-
ownership, domain-boundary, adapter-placement, and chronological-integration
stops. The canonical roadmap therefore contains **381 exact stops**:
...
The 35 coherence additions live in
...
| Domain retirement | `0.30.28–0.30.29`, `0.51.5–0.51.15`, `0.145.4` | Truthful terminals; cut/plan/guard/root; tenant-local residual handoff and evolving lineage; slot-scoped takeover; reserved terminalization/cleanup; lineage-aware reinstall; certification |
...
again before implementation. The roadmap checker verifies all 381 headings,
