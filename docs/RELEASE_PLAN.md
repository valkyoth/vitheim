...
The canonical roadmap contains 402 exact stops: 150 base `0.x.0` stops, 251
...
`0.51.3–0.51.36`, `0.60.4`, `0.70.5`, `0.100.2`, `0.118.5`,
...
| --- | --- | --- |
| `0.1.0` | Workspace, architecture laws, threat-model format, CI, private crates, evidence-status manifest, canonical 402-stop roadmap manifest, and release baseline | Repository trust, CI permissions, action pins, source/publication policy, count/claim drift, fail-closed release gate |
...
| `0.51.32` | One-shot successor-lifecycle genesis with closed top-or-pre-operational-lowered authority | Tag/member substitution, lowering adoption replay, admission-permit misbinding, eligibility re-consumption, duplicate lifecycle |
| `0.51.33` | Tagged initial/replacement final activation consuming the same effective-restriction branch and creating deferred predecessor cleanup | Genesis/effective-restriction substitution, double eligibility consumption, missing lowering manifest/capacity, abort race, partial activation |
| `0.51.34` | Reinstall delivery-barrier/evaluation-fence release or funded successor-retention reconciliation | Wrong control release, residual restriction loss, outage/replay, unfunded retention, premature cleanup, consumed revival, new-generation blockage |
| `0.51.35` | Atomic already-operational restriction-lowering guard CAS with predecessor release manifest | Stale prepared root, unrelated guard loss, partial CAS/manifest, early top release, response-loss divergence |
| `0.51.36` | Predecessor-top release or funded-retention reconciliation and capacity conservation | Omitted enforcement point, unsafe release, unfunded/double retention, stale routing/evidence, conservation mismatch, premature cleanup |
