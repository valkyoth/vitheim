...
The canonical roadmap contains 396 exact stops: 150 base `0.x.0` stops, 245
...
cloud-discovery companions. The coherence reviews added 50 requirement-source,
...
`0.51.3–0.51.30`, `0.60.4`, `0.70.5`, `0.100.2`, `0.118.5`,
...
| --- | --- | --- |
| `0.1.0` | Workspace, architecture laws, threat-model format, CI, private crates, evidence-status manifest, canonical 396-stop roadmap manifest, and release baseline | Repository trust, CI permissions, action pins, source/publication policy, count/claim drift, fail-closed release gate |
...
| `0.51.28` | One-shot post-quarantine replacement evaluation reservation and fresh successor-lifecycle genesis | Missing/replayed eligibility, ordinary-evaluation bypass, predecessor/root/floor substitution, identity reuse, duplicate successor |
| `0.51.29` | Exact guard supersession with lifecycle/admission/bridge-ownership/genesis roots, absorbing cut/evaluation consumption, operational transfer, and dual release manifest | Stale admission/status/evaluation, abort/expiry race, wrong genesis authority, unfunded bridge owner, unsafe retained namespace, partial consumption |
| `0.51.30` | Reinstall delivery-barrier/evaluation-fence release or funded successor-retention reconciliation | Wrong control release, residual restriction loss, outage/replay, unfunded retention, premature cleanup, consumed revival, new-generation blockage |
