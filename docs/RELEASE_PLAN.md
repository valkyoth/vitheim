...
| `0.146.0` | Provider-governance, topology anti-replay, rotation/drift, credential-TCB, cancellation and migration/import contention certification | Fault/fuzz retirement EvidenceUnavailable, all five CAS operations, terminal response loss, analytical cost breakpoints/weakening/rollback/partial re-cost, parent aggregate overflow, checkpoint gaps, cursor recreation, free rescans, child churn and protected-capacity exhaustion beside prior crashes |
