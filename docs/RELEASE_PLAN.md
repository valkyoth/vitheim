...
| `0.18.3` | Declared ownership roots including split global/local active law-catalog authority, activation-floor catalogs/envelopes, shared runtime/CLI verifier, independently admitted manifests, closed semantic realization, lifecycle, and authority registry | `VIT-INV-057` global CAS plus `VIT-INV-058` local catalog/distrust/time ratchets under `VIT-LAW-007`; no shared authority row; planning-superset isolation; exact compiled/signed enum and scope; canonical cryptographic artifact verification; gap-free milestone selection; bounded-time rollback/suspend/restore failure; stage-aware Rust P/N/M/F tests |
| `0.18.4` | Source-delivery- and journal-complete bounded evaluator re-evaluation plus first active-catalog successor | Actual predecessor-envelope verification; global/local partial rollout, unreachable/stale node, activation/revocation propagation, failover/restore; existing atomic campaign/source/membership barriers and outage/fairness cases |
...
| `0.19.0` | Integrity chains and signed-checkpoint interface | Event tamper/domain separation plus verified catalog epoch/digests, activation floor, exact scope/profile/validity uncertainty/signer/root/revocation/successor, global activation receipt, and independent local catalog/distrust/time ratchets |
...
| Version | Goal and deliverable | Release-specific verification / pentest target |
| --- | --- | --- |
| `0.21.0` | Stable-invariant, law-manifest, split active-catalog lineage/local-ratchet envelope, and semantic-realization storage negotiation | Distinct `VIT-CAP-057` global owner/CAS and `VIT-CAP-058` local catalog/distrust/time state; planning/active separation; exact profile/scope/full envelope; shared verifier support; manifest/catalog persistence; closed realization |
| `0.22.0` | Declaration-derived destructive invariant and ancestry-complete generation-pinned law/catalog conformance | Every effective tuple/realization including `VIT-LAW-007`; future tuple, combined/profile-invalid field, text artifact, digest/ancestry/predecessor/scope/signature mutation, partial rollout, revocation lag, time rollback/suspend/unavailability, ratchet rollback, and self-consistent-untrusted rejection |
...
| `0.29.0` | Resumable invariant-owner and trusted law/catalog migrations preserving monotonic authority | Preserve separate `VIT-INV-057` global lineage and `VIT-INV-058` local catalog/distrust/time ratchets plus complete verified payload/envelope/predecessor/revocation state, owner fences, floors, and anti-resurrection |
| `0.30.0` | Cross-backend export and import with explicit law trust closure | Invoke the shared verifier; reject planning/active confusion, catalog/envelope/ancestry omission, global/local-owner or time-ratchet loss, wrong scope/predecessor, untrusted/future tuple, silent generation/profile upgrade, substitution, truncation, and integrity loss |
...
| Version | Goal and deliverable | Release-specific verification / pentest target |
| --- | --- | --- |
| `0.140.1` | Cryptography/time, exact law-catalog profile/envelope, and credential-operation/rotation/recovery-root decision | Select exactly `CompiledCatalog` or `SignedCatalog`; freeze shared verifier digest/signature, compiled expected digests or dedicated root ceremony, exact scope/validity/successor fields, trustworthy-time source, maximum uncertainty, rollback/suspend behavior, and credential/remediation profiles |
| `0.140.2` | Storage topology for invariant/law manifests, owned active catalogs/ratchets, realizations, and provider state | Zero-missing ancestry/root/generation/capability/realization matrix; separate `VIT-INV-057` global and `VIT-INV-058` local row placement; payload/envelope/predecessor/revocation/catalog/distrust/time-ratchet persistence without storage-derived trust |
...
| `0.140.6` | Deployment/HA invariant-owner, admitted law-generation/catalog-lineage, and recovery decision | Global owner failover plus independent local admission; partial rollout/unreachable-node fencing; prioritized revocation propagation; trusted-time loss/suspend/rollback; full verifier/envelope/ancestry placement; typed recovery and RPO/RTO |
...
| `0.145.0` | Backup, restore, and disaster recovery | Recover `VIT-INV-057` global lineage separately from `VIT-INV-058` local catalog/distrust/time ratchets; freshly reverify exact artifact and time; reject expiry extension, rollback, future/stale/partial/profile-invalid/self-consistent-untrusted catalogs |
