...
| Version | Required context and deliverable | Verification and exit condition |
| --- | --- | --- |
| `0.29.0` | Implement pinned genesis trust; named observation-registry authority port/profile; operational claim admission/drain/expiry, PreparedNonAuthoritative local mutation, registry Confirm/Reject/status and local finalize; executor/provider redemption for effects; complete registration/cancellation/terminal/permanent-seal/fence-anchor response-loss lanes; monotone unresolved/late-evidence lattice; sealed frontier; disjoint `C/H` and `E/J`; expanded `B_EM`/`R_first` | Crash/race every claim, drain, local prepare, registry disposition, local finalize, effect send and observation lane. Restore an older backup after local fence. Reject distributed-CAS assumptions, check-then-use, transient-as-permanent, late-evidence loss, weak adapter, TOFU, writer substitution and underfunding |
| `0.30.0` | Export/import root state plus registry conformance identity, authority state/claim/frontier, every prepared mutation and registry disposition, observation attempt/reservation/settlement/status/seal/late evidence, restore protocol state, `E/J` and expanded maintenance ledger | Round trip every cut. Missing/forked/rolled-back/defaulted claim, preparation, confirmation, seal, frontier, provider-fence receipt or conformance identity remains Unready; import invents no authority/permanence/capacity |
| `0.140.1` | Freeze encodings, domains and result/conflict surfaces for port/profile, claims/drain, prepared mutation/disposition, response-loss lanes, unresolved lattice, restore protocol, genesis, `E/J` and equations | Review rejects external/local atomicity, current-status proof, generic status/result aliases, missing late-evidence edge, stale claim redemption, unknown profile field and cyclic commitments |
| `0.140.2` | Freeze external-before-local claim acquisition, local prepare, external publish, receipt-driven local finalize; zero-lock-across-I/O rule; claim drain/query permit; effect redemption; all observation/status/seal transactions; `E→J→F`; restore prepare/confirm/reconcile | Fault every boundary. No Prepared/Rejected state is authoritative, no drain reaches query permission with live claims, stale effect definitely does not send, and no backend requires a distributed transaction |
| `0.140.3` | Separate registry operator, claim issuer, local preparer/finalizer, provider-fence executor, observation registrar/query/terminalizer, seal authority, fence custodian, restore activator, genesis roles and capacity auditor | No actor self-confirms its preparation, bypasses drain/provider fence, manufactures permanent resolution, suppresses late evidence, self-certifies conformance or erases evidence |
| `0.140.5` | Retain conformance identity, claim/disposition frontier, prepared/final result links, every observation/status/seal/late-evidence record, root history, `E/J/F` ancestry and class consumption | Compaction cannot lose a live claim, turn prepared into committed, omit late contradiction, turn transient into sealed, forge completeness, alias archives, reset limits or weaken custody |
| `0.140.6` | Freeze failover at every claim/drain/expiry, prepare/confirm/reject/finalize, provider redemption, observation Publish/query/seal, local fence/`E/J/F`, restore protocol and budget boundary | Takeover is status/Reconcile only, recreates no permit/claim/token, preserves exact counters/dispositions and refuses authority when registry/provider/conformance continuity is unavailable |
| `0.140.11` | Decide pinned-root profile; concrete registry provider/finality/failure-domain/keys/retention/budgets; local backend claim-preparation capability; provider/executor fence enforcement; FenceEvidence backend; maxima/custody/export. Keep replenishment/manual root recovery unsupported | Architecture/security/legal/forensic/operations approve one exact end-to-end profile. Any local backend, registry or provider unable to prove the protocol refuses recovery activation |
| `0.142.0` | Expose read-only conformance identity, authority/drain/claim/preparation/disposition, observation lattice/status/seals, restore protocol, genesis, `E/J/F` and budget state | RPC cannot acquire/redeem claims, confirm preparations, seal permanence, discard late evidence, bypass provider fence, translate statuses, mint permits or replenish capacity |
| `0.143.0` | Model claim/drain/query-permit, local prepare/registry confirm/finalize, provider redemption, all response-loss lanes, late contradiction, restore, root lifecycle, `C/H` versus `E/J` and class conservation | No reachable state commits from a stale check, exposes prepared authority, sends after fence, loses contradiction, manufactures permanence, revives authority or violates conservation |
| `0.145.0` | Restore conformance identity, registry authority/claim frontier, prepared/disposition pairs, complete observation lattice/status/seal/late evidence, pointer/fence anchors, `E/J/F`, budget and hot suffix; then run prepare/confirm/reconcile activation | Older backups, live/unknown/exhausted/sealed/late/pending observations, incomplete claims, missing provider evidence or rejected preparation remain Unready/FencedEvidenceVerified |
| `0.146.0` | Fuzz port/profile fields, claim/epoch/frontier/preparation/disposition IDs, response-loss states, seal/late-evidence transitions, restore protocol, archive discriminants and equations | Tenant/profile/receipt substitution, reorder/replay, ABA/wrap, stale redemption, status alias, omission, overflow, one-short escrow and replenishment fail closed |
| `0.147.0` | Audit TCB port conformance, claim/drain and provider enforcement, preparation authority boundary, observation/permanent/late-evidence semantics, trust/SoD, custody and DR | Zero high/critical distributed-atomicity, check-use, stale-send, manufactured-permanence, evidence-loss, adapter, accounting, trust or role finding |
| `0.148.0` | Reject imports lacking conformance identity, claim/disposition and prepared-state history, explicit observation response/seal/lattice state, dedicated `E/J` or immutable expanded budget | No shim uses epoch reads as fences, maps prepared to committed, defaults transient/permanent state, drops late evidence, aliases status/archive or infers escrow |
| `0.149.0` | Pentest partitions/stale leaders/delayed receipts/rollback/fork/failover/epoch races/tenant substitution, stale claim send, prepared-state exposure, status confusion, seal forgery, late-evidence suppression, root/archive/funding attacks | Zero unresolved critical/high and no waived port-conformance, portable-ordering, provider-fence, response-loss, evidence-lattice, anti-rollback, trust, archive or custody issue |
| `0.150.0` and `1.0.0` | Demonstrate unchanged candidate across every selected local database, registry, executor/provider fence, archive, signer, HA and restore profile, including claim-drain races, local-fence-before-anchor crash and hard exhaustion | Production remains blocked until every component passes Phase C, cross-adapter conformance, DR, independent audit and pentest; unsupported combinations remain explicitly refused |
