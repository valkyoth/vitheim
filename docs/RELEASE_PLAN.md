...
| Version | Required context and deliverable | Verification and exit condition |
| --- | --- | --- |
| `0.29.0` | Add Open→SealPending→Sealed external-transfer state, immutable provider fence receipt and unknown seal reconciliation; reopening requires a provider-authenticated never-completed receipt, and MarkEligible requires exact Sealed. Add evaluator reassessment, explicit capacity deficit and non-borrowable emergency reserve without clamping; define EffectiveCharge=base+covered deficit and atomic DeficitSettlement into final/unknown members. Remediation-authorized evaluator migration may exceed the old maximum only for an already-covered exact delta and returns a typed Commit/Replan/permanent-retention continuation. Give deficit remediation and unknown resolution complete destination-applied six-state authorization/expiry/revocation/inbox/tombstone/outcome machinery. Wire stable cumulative-budget charges into every post-Begin admission and a bounded pre-Begin admission pool whose winning reservation atomically activates into the new lineage budget. Add retained-unknown resolution and platform-wide ceilings; normalize all six release actions to matching action-specific results | No delayed completion survives reopening; final conservation includes every deficit; destructive evidence is not reusable authority; Begin has no circular or uncharged budget dependency; retained Unknown remains governed |
| `0.30.0` | Export/import transfer mutation/seal/never-completed epochs, Sealed receipts/fences, reassessment/EffectiveCharge/deficit-settlement/emergency provenance, full remediation/resolution authorization state and revocation history, pre-Begin candidates/charges/activation/cleanup, every lineage charge and original quarantine link | Missing/defaulted/forked seal, liability, authority, bootstrap charge or adjudication state preserves the larger encumbrance and leaves the destination fenced/unready |
| `0.140.1` | Freeze seal/reconcile/never-completed receipt preimages, EffectiveCharge/DeficitSettlement arithmetic and provenance, both full destructive-authorization families, and pre-Begin budget/charge/activation encodings | Review proves late completion, hard-maximum clamping, omitted/stranded deficit, reusable authorization, bootstrap gap/double charge and late-evidence authority impossible |
| `0.140.2` | Freeze Open/SealPending/Sealed CAS/provider fence, base+deficit→member atomic Commit, remediation continuation, both authorization first-terminal tables, exhaustive post-Begin charging and pre-Begin activation/cleanup transactions | Every backend proves one exact write/accounting/authority/budget winner within declared bounds or refuses custody transfer |
| `0.140.3` | Freeze adapter/sealer/reconciler, assessor, emergency-reserve/deficit-settlement owners, remediation and resolution issuer/admitter/revoker/applier/operator roles, pre-Begin budget owner/Begin operator and legal-hold roles | No sole actor reopens a transfer, covers/hides/settles a deficit, self-authorizes deletion, manufactures Begin capacity or releases uncertainty |
| `0.140.5` | Retain mutation/seal/never-completed history, EffectiveCharge/DeficitSettlement and emergency provenance, complete authorization tombstone/outcome chains, original pre-Begin buckets/activation/cleanup, lineage charges and quarantine/resolution chain | Compaction/erasure cannot permit late completion, omit liability, reuse authority, reset charges, invent Begin or rewrite quarantine |
| `0.140.6` | Freeze rolling-upgrade/failover/restore of SealPending/Sealed, base/emergency deficit conservation, both authorization state machines, pre-Begin candidates/activation and retained-unknown resolution | Unknown response retains the old seal request, full encumbrance and candidate charge; incomplete history is unready and never guessed |
| `0.142.0` | RPC exposes typed seal/non-completion, EffectiveCharge/DeficitSettlement, destructive-authorization outcome, pre-Begin charge and resolution status/evidence only | Remote status cannot reopen/seal, debit/release capacity, admit/consume authority, activate a lineage budget or adjudicate a member |
| `0.143.0` | Model delayed completion after reopen, distrust deficit above maximum through final Commit, both six-state authorization families, competing Begin candidates and every charge/cleanup/legal-hold crash point | No stale completion, omitted/stranded deficit, reusable authority, budget bootstrap bypass/double charge or unauthorized release is reachable |
| `0.145.0` | Restore exact seal/non-completion chain, base/emergency/member conservation, authorization revocation/tombstone/outcomes, pre-Begin candidate activation/cleanup and immutable quarantine/resolution history | Any missing relationship preserves SealPending, the larger charge, non-consumed authority and candidate encumbrance |
| `0.146.0` | Fuzz seal/provider-operation epochs, EffectiveCharge/deficit overflow and settlement provenance, both authorization codecs/tables, pre-Begin pool/candidate arithmetic and resolution evidence | Reorder, ABA, late completion, omission/double count, stale sequence, duplicate activation/charge, incomplete deletion and legal-hold bypass fail closed |
| `0.147.0` | Audit provider permanent-cancellation capability, final accounting conservation, emergency reserve provisioning, complete destructive-authority machinery, pre-Begin/lineage budget continuity, resolution SoD and all-six-action parity | Zero high/critical write-fence, conservation, resource, custody, legal-hold, authority, restore or parity finding |
| `0.148.0` | Reject legacy encodings without permanent non-completion proof, EffectiveCharge/DeficitSettlement, full authorization families, pre-Begin charge/activation, per-admission charge or unknown-resolution chain | No compatibility shim invents immutability, capacity, authority, budget ancestry, settlement or resolution |
| `0.149.0` | External pentest targets late multipart/seal completion after reopen, evaluator undercharge through final Commit, emergency capacity stranding, reusable deletion grants, expiry/revocation races, pre-Begin exhaustion/competing grants/crash cleanup, cumulative-charge evasion and legal-hold bypass | Zero unresolved critical/high findings and no waived immutability, conservation, boundedness, custody or authorization issue |
| `0.150.0` and `1.0.0` | Demonstrate exact continuity for sealed objects, permanent non-completion reconciliation, base+deficit member settlement, complete destructive authorization, pre-Begin→lineage budget transfer and governed retained-unknown resolution | Production remains blocked until every selected provider proves hard fencing/non-completion, all adapters pass and the unchanged commit passes independent pentest |
