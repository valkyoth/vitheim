...
| Version | Required context and deliverable | Verification and exit condition |
| --- | --- | --- |
| `0.29.0` | Add Open→SealPending→Sealed external-transfer state, immutable provider fence receipt and unknown seal reconciliation; MarkEligible requires exact Sealed and no later writes. Add evaluator reassessment, explicit capacity deficit and non-borrowable platform emergency/quarantine reserve without plan-maximum clamping; uncovered deficit fences readiness and separate provisioning/deletion/migration remediation is required. Wire stable cumulative-budget charges into every destination admission with exact-retry join and protected Recovery capacity. Add RetainedUnknown→ConfirmedPresent/DeletionVerified/PermanentlyUnresolvable resolution under a separate complete authorization family and platform-wide count/capacity ceilings. Normalize all six release actions to matching action-specific results | Delayed chunks cannot invalidate a committed receipt; evaluator compromise cannot hide a deficit; no operation evades cumulative ceilings; retained Unknown can be adjudicated without automatic refund or quarantine rewrite |
| `0.30.0` | Export/import transfer mutation/seal epochs, Sealed receipts/fences, reassessment/deficit/emergency-reserve/remediation ledgers, every budget-charge settlement identity/state and unknown-resolution authorization/state/result with original quarantine link | Missing/defaulted/forked seal, liability, charge or adjudication state preserves conservative capacity and leaves the destination fenced |
| `0.140.1` | Freeze seal/reconcile receipt preimages, evaluator reassessment/deficit/remediation arithmetic, emergency reserve, budget-charge and unknown-resolution authorization/result encodings | Review proves root/size/version rebinding, hard-maximum clamping, hidden deficit, double/omitted charge, late-evidence authority and action-result omission impossible |
| `0.140.2` | Freeze Open/SealPending/Sealed CAS and provider fence, atomic deficit/reserve debit or readiness fence, exhaustive command+budget-charge transactions, and unknown-member conversion/release transactions | Every backend proves hard write fencing and one exact atomic winner within declared bounds or custody transfer is unsupported |
| `0.140.3` | Freeze transfer adapter/sealer/reconciler, evaluator assessor, emergency-reserve owner, deficit remediator, budget owner, unknown-resolution issuer/admitter/operator and legal-hold roles | No stale adapter, evaluator owner, tenant or sole operator seals, covers/hides a deficit, settles budget or releases retained uncertainty |
| `0.140.5` | Retain mutation/seal history, immutable Sealed receipt, reassessment/deficit/remediation, emergency-reserve provenance, original charge buckets/dispositions and quarantine-plus-resolution chain | Compaction/erasure cannot reopen writes, clamp liability, reset cumulative charges, lose exact settlement or rewrite quarantine |
| `0.140.6` | Freeze rolling-upgrade/failover/restore of SealPending/Sealed, emergency deficit/fences, charge reservations and retained-unknown resolution | Unknown response remains pending; incomplete provider/evaluator/ledger history is unready and never guessed |
| `0.142.0` | RPC exposes typed seal, deficit, budget-charge and unknown-resolution status/evidence only | Remote status cannot seal, debit/release emergency capacity, settle charges or adjudicate retained members |
| `0.143.0` | Model delayed/stale multipart writes against sealing, distrust deficits beyond plan maximum, all command/charge crash points and resolution/legal-hold races | No stale post-seal write, hidden/uncovered ready deficit, cumulative-budget bypass or unauthorized release is reachable |
| `0.145.0` | Restore exact transfer mutation/seal chain, emergency capacity/liabilities, charge settlements and immutable quarantine/resolution history from authenticated checkpoints | Any missing relationship preserves fence, charge and unready status |
| `0.146.0` | Fuzz seal/root/size/ETag/version/provider fences, corrected-charge/deficit overflow, reserve exhaustion, charge identity/buckets and resolution evidence/action codecs | Reorder, ABA, clamping, overflow, duplicate charge, incomplete namespace absence and legal-hold bypass fail closed |
| `0.147.0` | Audit provider immutability capability, accounting honesty, emergency-reserve provisioning, exhaustive budget wiring, resolution SoD and all-six-action table parity | Zero high/critical write-fence, deficit, resource, custody, legal-hold, authority, restore or parity finding |
| `0.148.0` | Reject legacy encodings without transfer seal, deficit/emergency-reserve, per-admission charge or unknown-resolution chain | No compatibility shim invents immutability, capacity, settlement or resolution |
| `0.149.0` | External pentest targets delayed chunks/stale credentials/multipart completion, seal-response ambiguity, evaluator undercharge above plan maximum, emergency-reserve exhaustion, cumulative-charge evasion/double settlement, retained-member refund and legal-hold/action-table bypass | Zero unresolved critical/high findings and no waived immutability, accounting, boundedness, custody or authorization issue |
| `0.150.0` and `1.0.0` | Demonstrate exact continuity for sealed immutable custody objects, honest deficit remediation, exhaustive lineage charging and governed retained-unknown resolution | Production remains blocked until every selected provider proves hard fencing, all adapters pass and the unchanged commit passes independent pentest |
