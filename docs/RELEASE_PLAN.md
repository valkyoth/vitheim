...
The canonical roadmap contains 414 exact stops: 150 base `0.x.0` stops, 263
...
`0.51.3–0.51.48`, `0.60.4`, `0.70.5`, `0.100.2`, `0.118.5`,
...
| --- | --- | --- |
| `0.1.0` | Workspace, architecture laws, threat-model format, CI, private crates, evidence-status manifest, canonical 414-stop roadmap manifest, and release baseline | Repository trust, CI permissions, action pins, source/publication policy, count/claim drift, fail-closed release gate |
