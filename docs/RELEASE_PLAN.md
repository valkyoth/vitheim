...
The canonical roadmap contains 377 exact stops: 150 base `0.x.0` stops, 226
...
`0.51.3–0.51.11`, `0.60.4`, `0.70.5`, `0.100.2`, `0.118.5`,
...
| --- | --- | --- |
| `0.1.0` | Workspace, architecture laws, threat-model format, CI, private crates, evidence-status manifest, canonical 377-stop roadmap manifest, and release baseline | Repository trust, CI permissions, action pins, source/publication policy, count/claim drift, fail-closed release gate |
...
| `0.51.10` | Bounded fair child execution and reconciliation into a mixed retired/never-present coverage manifest | Unauthorized dispatch, guard/handoff bypass, fabricated retirement for absence, missing coverage, invalid cancel/resume, cursor rollback, starvation |
| `0.51.11` | Permanent deployment-domain guard takeover, campaign-guard release, and final clean parent completion | Temporal protection gap, stale node/import bypass, forged transfer receipt, early completion, ordinary re-enable, reinstall-authority bypass |
