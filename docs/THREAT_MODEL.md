...
| A composite law retroactively acquires a future root, changes semantics behind an unchanged label, or a later milestone silently omits authority review | Canonical contiguous law generations with exact effective dependency delta/coordinator/semantics/activation/migration/rollback/recovery binding; future-root and latest-view drift rejection; exactly one checked authority disposition for every post-bootstrap milestone; zero unresolved proposals before Phase O/production |
